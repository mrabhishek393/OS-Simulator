...
void print_partitions(vector<int> assigned_process, vector<int> partitions_size_alloc, vector<int> partitions, int memory_block_count)
{
    ...
    while(true)
    {
        ...
        if(choice == 1)
        {
            ...
            if(process_allocated)
            {
                ...
                print_partitions(assigned_process, partitions_size_alloc, partitions, memory_block_count);
                continue;
            }
